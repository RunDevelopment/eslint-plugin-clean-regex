 ...
 * @typedef {import("regexpp/ast").NodeBase} NodeBase
 */
 ...
 * @property {(element: NodeBase) => { loc: SourceLocation }} reportElement
 * @property {() => { loc: SourceLocation }} reportFlags
 * @property {(element: NodeBase, replacement: string) => { loc: SourceLocation, fix: (fixer: RuleFixer) => Fix }} replaceElement
