		...
		return createRuleListener(({ visitAST, flags, replaceElement, reportElement }) => {
			...
			function process(node) {
				...
				if (nonDisjointAlt) {
					...
					context.report({
						message: `The set of characters accepted by ${mention(nonDisjointAlt.alternative)} is not disjoint with the set of characters accepted by previous alternatives. Try to remove this ambiguity.` + expMessage,
